...
chain=main`
	...
	if !(btcConfig.Sections[0].End.Line == 1 && btcConfig.Sections[0].End.Character == 10) {
		t.Errorf("Expected section to end at line 1, character 10, but got %v", btcConfig.Sections[0].End)
	}
}
