...
var Options = map[string]docvalues.DocumentationValue{
	"Host": docvalues.DocumentationValue{
	...
	"AddKeysToAgent": docvalues.DocumentationValue{
	...
	"BatchMode": docvalues.DocumentationValue{
	...
	"BindAddress": docvalues.DocumentationValue{
	...
	"CanonicalizeFallbackLocal": docvalues.DocumentationValue{
	...
	"CanonicalizeHostname": docvalues.DocumentationValue{
	...
	"CanonicalizeMaxDots": docvalues.DocumentationValue{
	...
	"CanonicalizePermittedCNAMEs": docvalues.DocumentationValue{
	...
	"CASignatureAlgorithms": docvalues.DocumentationValue{
...
rsa-sha2-512,rsa-sha2-256
	...
	"CertificateFile": docvalues.DocumentationValue{
	...
	"ChannelTimeout": docvalues.DocumentationValue{
		Documentation: `Open X11 forwarding sessions.`,
		Value:         docvalues.StringValue{},
	},
	"CheckHostIP": docvalues.DocumentationValue{
...
aes128-gcm@openssh.com,aes256-gcm@openssh.com
	...
	"ClearAllForwardings": docvalues.DocumentationValue{
	...
	"ConnectionAttempts": docvalues.DocumentationValue{
	...
	"ConnectTimeout": docvalues.DocumentationValue{
	...
	"ControlMaster": docvalues.DocumentationValue{
	...
	"ControlPath": docvalues.DocumentationValue{
	...
	"ControlPersist": docvalues.DocumentationValue{
	...
	"DynamicForward": docvalues.DocumentationValue{
	...
	"EnableEscapeCommandline": docvalues.DocumentationValue{
	...
	"EnableSSHKeysign": docvalues.DocumentationValue{
	...
	"EscapeChar": docvalues.DocumentationValue{
	...
	"ExitOnForwardFailure": docvalues.DocumentationValue{
	...
	"ForkAfterAuthentication": docvalues.DocumentationValue{
	...
	"ForwardAgent": docvalues.DocumentationValue{
	...
	"ForwardX11": docvalues.DocumentationValue{
	...
	"ForwardX11Timeout": docvalues.DocumentationValue{
	...
	"ForwardX11Trusted": docvalues.DocumentationValue{
	...
	"GlobalKnownHostsFile": docvalues.DocumentationValue{
	...
	"GSSAPIDelegateCredentials": docvalues.DocumentationValue{
		Documentation: `Forward (delegate) credentials to the server. The default is no.`,
		Value:         docvalues.StringValue{},
	},
	"HashKnownHosts": docvalues.DocumentationValue{
...
rsa-sha2-512,rsa-sha2-256
	...
	"HostKeyAlgorithms": docvalues.DocumentationValue{
...
rsa-sha2-512,rsa-sha2-256
	...
	"HostKeyAlias": docvalues.DocumentationValue{
	...
	"Hostname": docvalues.DocumentationValue{
	...
	"IdentitiesOnly": docvalues.DocumentationValue{
	...
	"IdentityAgent": docvalues.DocumentationValue{
	...
	"IdentityFile": docvalues.DocumentationValue{
	...
	"IgnoreUnknown": docvalues.DocumentationValue{
	...
	"IPQoS": docvalues.DocumentationValue{
	...
	"KbdInteractiveDevices": docvalues.DocumentationValue{
...
diffie-hellman-group14-sha256
	...
	"KnownHostsCommand": docvalues.DocumentationValue{
	...
	"LocalCommand": docvalues.DocumentationValue{
	...
	"LocalForward": docvalues.DocumentationValue{
	...
	"LogVerbose": docvalues.DocumentationValue{
...
hmac-sha2-256,hmac-sha2-512,hmac-sha1
	...
	"NoHostAuthenticationForLocalhost": docvalues.DocumentationValue{
	...
	"NumberOfPasswordPrompts": docvalues.DocumentationValue{
	...
	"ObscureKeystrokeTiming": docvalues.DocumentationValue{
	...
	"PermitLocalCommand": docvalues.DocumentationValue{
	...
	"PermitRemoteOpen": docvalues.DocumentationValue{
	...
	"PKCS11Provider": docvalues.DocumentationValue{
	...
	"PreferredAuthentications": docvalues.DocumentationValue{
...
keyboard-interactive,password`,
	...
	"ProxyCommand": docvalues.DocumentationValue{
	...
	"ProxyJump": docvalues.DocumentationValue{
	...
	"ProxyUseFdpass": docvalues.DocumentationValue{
...
rsa-sha2-512,rsa-sha2-256
	...
	"RemoteCommand": docvalues.DocumentationValue{
	...
	"RemoteForward": docvalues.DocumentationValue{
	...
	"RequestTTY": docvalues.DocumentationValue{
	...
	"RevokedHostKeys": docvalues.DocumentationValue{
	...
	"SecurityKeyProvider": docvalues.DocumentationValue{
	...
	"SendEnv": docvalues.DocumentationValue{
	...
	"ServerAliveCountMax": docvalues.DocumentationValue{
	...
	"ServerAliveInterval": docvalues.DocumentationValue{
	...
	"SessionType": docvalues.DocumentationValue{
	...
	"SetEnv": docvalues.DocumentationValue{
	...
	"StdinNull": docvalues.DocumentationValue{
	...
	"StrictHostKeyChecking": docvalues.DocumentationValue{
	...
	"TCPKeepAlive": docvalues.DocumentationValue{
	...
	"Tag": docvalues.DocumentationValue{
	...
	"Tunnel": docvalues.DocumentationValue{
	...
	"TunnelDevice": docvalues.DocumentationValue{
	...
	"UpdateHostKeys": docvalues.DocumentationValue{
	...
	"User": docvalues.DocumentationValue{
	...
	"UserKnownHostsFile": docvalues.DocumentationValue{
	...
	"VerifyHostKeyDNS": docvalues.DocumentationValue{
	...
	"VisualHostKey": docvalues.DocumentationValue{
